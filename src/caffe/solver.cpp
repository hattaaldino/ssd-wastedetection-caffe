...
void Solver<Dtype>::UpdateSmoothedLoss(Dtype loss, int start_iter,
  ...
  if (losses_.size() < average_loss) {
    ...
    /* 
     * Menghitung smoothed_loss:
     * 1. Mencari tahu posisi(idx) nilai loss pada kumpulan loss yang dirata-rata.
     * 2. Mengambil nilai loss pada posisi yang sama di *average_loss* iterasi terakhir.
     * 3. Gunakan nilai loss -terakhir- untuk merepresentasikan nilai loss -saat ini- 
     *    di nilai *smoothed_loss_* yang sudah didapatkan di iterasi average_loss sebelumnya.
     * 4. Normalisasi nilai representasi loss dengan jumlah bagi rata-rata.
     * 5. Tambahkan semua nilai representasi di tiap posisi nilai loss terbaru untuk
     *    mendapatkan nilai rata-rata loss pada *average_loss* iterasi terakhir
    */
